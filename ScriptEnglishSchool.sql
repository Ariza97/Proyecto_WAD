...
insert into usuarios(nombre,apellido,idLog,correo,pass,idRol) values ('Samantha','Olmos','samichampi99','champi99@gmail.com','aleychampi',1);
insert into usuarios(nombre,apellido,idLog,correo,pass,idRol) values ('123','Ariza','123','123@gmail.com','123',1);
insert into usuarios(nombre,apellido,idLog,correo,pass,idRol) values ('Ruben','Peredo','rperedo','rubenpv@gmail.com','rpv',1);
insert into administrador(idUsuarios) values (1);
insert into administrador(idUsuarios) values (2);
insert into administrador(idUsuarios) values (3);


create view admins as select u.idUsuarios,u.correo,u.pass from usuarios u,administrador a where u.idUsuarios = a.idUsuarios;
create view profes as select u.idUsuarios,u.correo,u.pass from usuarios u,profesor p where u.idUsuarios = p.idUsuarios;
create view alumnos as select u.idUsuarios,u.correo,u.pass from usuarios u,alumno al where u.idUsuarios = al.idUsuarios;

/*Insertar grupo sin profesor asignado*/
insert into grupo(nombre,pass) values ('1CM1','e_1cm1AM');
insert into grupo(nombre,pass) values ('1CM2','e_1cm2EW');
insert into grupo(nombre,pass) values ('1CM3','e_1cm3FV');
insert into grupo(nombre,pass) values ('1CM4','e_1cm4TR');
insert into grupo(nombre,pass) values ('1CM5','e_1cm5YH');
insert into grupo(nombre,pass) values ('1CM6','e_1cm6RT');
